# Illustrative Sample Output - User Interview Evidence Index
...
- Signal: interview transcripts and consent metadata produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a searchable claim index that retains speaker and timestamp references.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- retrieval time for a validated quote: baseline pending from the first two runs.
