# Illustrative Sample Output - All-hands Rehearsal Pack
...
- Signal: run of show, speaker notes, and time limits produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a rehearsal pack with timing checks and unresolved handoffs.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- agenda items rehearsed within the timebox: baseline pending from the first two runs.
