# Illustrative Sample Output - Learning Sprint Planner
...
- Signal: a learning goal, available sessions, and prior progress notes produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a small sprint plan with practice tasks and an evidence checkpoint.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- planned practice sessions completed: baseline pending from the first two runs.
