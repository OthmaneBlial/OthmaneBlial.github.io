# Illustrative Sample Output - Channel Partner Pipeline Digest
...
- Signal: partner-sourced opportunities and activity notes produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a partner digest with stalled motions and requested enablement.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- partner opportunities with a next action: baseline pending from the first two runs.
