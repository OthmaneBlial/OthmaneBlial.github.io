# Illustrative Sample Output - Speaker Notes Rehearsal Coach
...
- Signal: speaker notes, rehearsal transcript, and time limit produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a rehearsal report with pacing, omitted points, and questions to verify.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- rehearsal sessions completed within the timebox: baseline pending from the first two runs.
