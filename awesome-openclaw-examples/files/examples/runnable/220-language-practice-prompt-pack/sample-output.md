# Illustrative Sample Output - Language Practice Prompt Pack
...
- Signal: learner notes, target vocabulary, and optional voice practice produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a private practice pack with corrections separated from suggestions.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- practice minutes completed with a reviewed correction: baseline pending from the first two runs.
