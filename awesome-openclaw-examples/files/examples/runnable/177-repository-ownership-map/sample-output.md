# Illustrative Sample Output - Repository Ownership Map
...
- Signal: repository metadata, CODEOWNERS, and recent maintenance activity produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for an ownership map with gaps, stale owners, and review dates.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- repositories with an accountable owner: baseline pending from the first two runs.
