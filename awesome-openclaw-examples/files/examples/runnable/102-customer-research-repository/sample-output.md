# Illustrative Sample Output - Customer Research Repository
...
- Signal: scattered interview notes and customer emails produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a tagged evidence index with source links and confidence labels.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- time to find supporting customer evidence: baseline pending from the first two runs.
