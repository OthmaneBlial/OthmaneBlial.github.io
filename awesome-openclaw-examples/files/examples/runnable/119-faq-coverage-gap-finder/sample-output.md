# Illustrative Sample Output - FAQ Coverage Gap Finder
...
- Signal: repeated questions and the current knowledge base produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a ranked list of unanswered questions with draft article outlines.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- repeat questions resolved by a published answer: baseline pending from the first two runs.
