# Illustrative Sample Output - Video Chapter Marker
...
- Signal: a video transcript or public video and chapter rules produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for draft chapter titles with timestamps and coverage gaps.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- chapters reviewed before publishing: baseline pending from the first two runs.
