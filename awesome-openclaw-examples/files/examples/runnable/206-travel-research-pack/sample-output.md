# Illustrative Sample Output - Travel Research Pack
...
- Signal: public destination information and a declared travel brief produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a source-linked travel comparison with constraints and open decisions.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- research time per itinerary decision: baseline pending from the first two runs.
