# Illustrative Sample Output - Focus Time Protection Brief
...
- Signal: calendar commitments and stated focus-time goals produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a review brief that spots collisions and proposes movable blocks.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- focus blocks preserved in the next planning window: baseline pending from the first two runs.
