# Illustrative Sample Output - Accessibility Copy Check
...
- Signal: interface copy, content context, and accessibility checklist produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a copy review with concrete issues and examples for human editing.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- blocking accessibility copy issues found before release: baseline pending from the first two runs.
