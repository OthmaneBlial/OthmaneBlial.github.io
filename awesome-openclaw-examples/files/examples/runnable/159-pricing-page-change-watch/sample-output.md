# Illustrative Sample Output - Pricing Page Change Watch
...
- Signal: approved pricing pages and dated snapshots produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a change digest that flags copy, plan, and disclaimer differences.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- pricing changes reviewed before internal distribution: baseline pending from the first two runs.
