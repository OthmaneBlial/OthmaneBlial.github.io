# Illustrative Sample Output - Landing Page Claim Verifier
...
- Signal: landing-page claims and their supporting source material produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a claim ledger with evidence, freshness, and approval status.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- public claims with a recorded supporting source: baseline pending from the first two runs.
