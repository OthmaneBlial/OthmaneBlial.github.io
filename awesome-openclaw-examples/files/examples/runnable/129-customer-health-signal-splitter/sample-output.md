# Illustrative Sample Output - Customer Health Signal Splitter
...
- Signal: mixed product, support, and relationship signals produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a transparent health view that keeps evidence types separate.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- health reviews containing a cited signal: baseline pending from the first two runs.
