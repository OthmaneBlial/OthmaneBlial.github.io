# Illustrative Sample Output - Workshop Facilitation Brief
...
- Signal: workshop goals, participant context, and known constraints produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a timed facilitation brief with prompts and capture points.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- workshops ending with documented next actions: baseline pending from the first two runs.
