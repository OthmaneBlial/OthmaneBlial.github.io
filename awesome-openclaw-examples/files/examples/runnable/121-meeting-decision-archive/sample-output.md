# Illustrative Sample Output - Meeting Decision Archive
...
- Signal: meeting notes, decisions, owners, and due dates produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a linked decision record with unresolved follow-ups.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- decisions with an owner and review date: baseline pending from the first two runs.
