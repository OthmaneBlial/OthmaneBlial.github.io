# Illustrative Sample Output - Digital Photo Curation Queue
...
- Signal: photo metadata, album goals, and selected captions produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a review queue for duplicates, albums, and caption drafts.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- photos reviewed per curation session: baseline pending from the first two runs.
