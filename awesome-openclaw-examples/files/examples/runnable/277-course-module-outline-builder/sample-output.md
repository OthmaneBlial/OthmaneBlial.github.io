# Illustrative Sample Output - Course Module Outline Builder
...
- Signal: course goals, learner level, source material, and constraints produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a module outline with outcomes, practice, and evidence checkpoints.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- modules with measurable learning outcomes: baseline pending from the first two runs.
