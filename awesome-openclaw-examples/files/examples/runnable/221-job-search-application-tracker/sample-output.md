# Illustrative Sample Output - Job Search Application Tracker
...
- Signal: job leads, application stages, and follow-up dates produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a private tracker with missing information and next actions.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- applications with a next review date: baseline pending from the first two runs.
