# Illustrative Sample Output - Subscription Renewal Watch
...
- Signal: subscription notices, renewal dates, and prior decisions produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a renewal queue with notice windows and cancellation-review prompts.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- renewals reviewed before the cancellation window: baseline pending from the first two runs.
