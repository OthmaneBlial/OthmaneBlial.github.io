# Illustrative Sample Output - Grant Application Evidence Map
...
- Signal: grant requirements, project evidence, and draft answers produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for an evidence map showing support, gaps, and reviewer questions.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- application claims with a supporting source: baseline pending from the first two runs.
