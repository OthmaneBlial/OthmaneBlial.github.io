# Illustrative Sample Output - Contract Obligation Calendar
...
- Signal: contract obligations, dates, owners, and source clauses produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a proposed obligation calendar with review status.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- obligations reviewed before their notice window: baseline pending from the first two runs.
