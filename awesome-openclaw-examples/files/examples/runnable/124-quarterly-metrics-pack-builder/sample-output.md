# Illustrative Sample Output - Quarterly Metrics Pack Builder
...
- Signal: approved metric snapshots and quarter-over-quarter notes produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a reviewable metrics pack with deltas, drivers, and missing data.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- time to prepare the quarterly review pack: baseline pending from the first two runs.
