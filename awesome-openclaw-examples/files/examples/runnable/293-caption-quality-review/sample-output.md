# Illustrative Sample Output - Caption Quality Review
...
- Signal: a transcript, caption file, and language or style rules produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a caption review for timing, names, omissions, and readability.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- caption issues fixed before publication: baseline pending from the first two runs.
