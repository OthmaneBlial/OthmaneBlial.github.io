# Illustrative Sample Output - Research Abstract Simplifier
...
- Signal: public research abstracts and a target reader level produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a plain-language summary with limitations and original links.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- summaries retaining the study's stated limitations: baseline pending from the first two runs.
