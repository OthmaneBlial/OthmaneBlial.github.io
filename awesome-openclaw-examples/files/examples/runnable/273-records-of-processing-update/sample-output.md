# Illustrative Sample Output - Records of Processing Update
...
- Signal: processing activities, system owners, and approved changes produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a draft register update with missing fields and evidence links.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- processing records reviewed after a material change: baseline pending from the first two runs.
