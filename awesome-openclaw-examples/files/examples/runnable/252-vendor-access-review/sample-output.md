# Illustrative Sample Output - Vendor Access Review
...
- Signal: vendor accounts, access owners, and contract scope produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a least-privilege review queue with evidence and an escalation path.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- vendor access records reviewed before renewal: baseline pending from the first two runs.
