# Illustrative Sample Output - Webinar Speaker Prep
...
- Signal: speaker bio, session brief, prior questions, and logistics produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a speaker prep pack with evidence-backed talking points and risks.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- speakers receiving prep before rehearsal: baseline pending from the first two runs.
