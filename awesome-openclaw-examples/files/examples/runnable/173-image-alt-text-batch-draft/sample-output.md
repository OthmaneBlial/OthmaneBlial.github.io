# Illustrative Sample Output - Image Alt-Text Batch Draft
...
- Signal: image context, intended audience, and accessibility rules produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for draft alt text with a human review queue for ambiguous images.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- images receiving reviewed alt text: baseline pending from the first two runs.
