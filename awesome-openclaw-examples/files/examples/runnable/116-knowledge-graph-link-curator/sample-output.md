# Illustrative Sample Output - Knowledge Graph Link Curator
...
- Signal: related documents, projects, people, and decisions produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a small set of proposed links with reasons and source references.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- accepted links per curation session: baseline pending from the first two runs.
