# Illustrative Sample Output - Study Plan Adaptive Coach
...
- Signal: learning goal, available sessions, practice history, and constraints produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a revised study plan with a human-selected next step.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- planned study sessions completed: baseline pending from the first two runs.
