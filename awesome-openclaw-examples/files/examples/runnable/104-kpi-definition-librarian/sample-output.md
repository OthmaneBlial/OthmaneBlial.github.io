# Illustrative Sample Output - KPI Definition Librarian
...
- Signal: metric definitions, dashboards, and decision notes produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a canonical KPI card with formula, owner, source, and caveats.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- percentage of metrics with an accountable owner: baseline pending from the first two runs.
