# Illustrative Sample Output - Community Question Roundup
...
- Signal: community questions and existing approved answers produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a weekly roundup separating answered, unanswered, and risky questions.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- repeat community questions with an owner: baseline pending from the first two runs.
