# Illustrative Sample Output - Compliance Control Evidence Index
...
- Signal: control statements, evidence links, and collection dates produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for an evidence index with freshness and gap status.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- controls with current, traceable evidence: baseline pending from the first two runs.
