# Illustrative Sample Output - Package License Review
...
- Signal: dependency manifests and approved license policy produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a review queue with package, version, license, and policy evidence.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- new license issues found before release: baseline pending from the first two runs.
