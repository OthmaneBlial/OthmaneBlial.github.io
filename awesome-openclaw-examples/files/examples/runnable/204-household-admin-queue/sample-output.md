# Illustrative Sample Output - Household Admin Queue
...
- Signal: household messages, reminders, and open administrative tasks produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a shared queue with owner, due date, and information needed to act.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- household tasks with a clear next owner: baseline pending from the first two runs.
