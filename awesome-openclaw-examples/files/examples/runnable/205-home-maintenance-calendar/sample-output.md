# Illustrative Sample Output - Home Maintenance Calendar
...
- Signal: maintenance notes, appliance dates, and recurring reminders produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a proposed calendar of maintenance tasks with lead time and owner.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- recurring maintenance completed before its due window: baseline pending from the first two runs.
