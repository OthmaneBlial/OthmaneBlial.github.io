# Illustrative Sample Output - SLO Exception Register
...
- Signal: SLO exceptions, expiry dates, and approval notes produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a register that flags expired or ownerless exceptions.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- exceptions with a current owner and review date: baseline pending from the first two runs.
