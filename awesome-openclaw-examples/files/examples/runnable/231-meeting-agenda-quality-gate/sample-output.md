# Illustrative Sample Output - Meeting Agenda Quality Gate
...
- Signal: meeting purpose, attendees, decisions needed, and prior actions produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a pre-meeting check for missing outcomes, owners, or evidence.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- meetings with a stated decision or learning goal: baseline pending from the first two runs.
