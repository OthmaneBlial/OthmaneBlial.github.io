# Illustrative Sample Output - Launch Messaging Consistency Check
...
- Signal: launch copy across a brief, landing page, and sales enablement produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a claim and terminology comparison with unresolved contradictions.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- inconsistent launch claims caught before review: baseline pending from the first two runs.
