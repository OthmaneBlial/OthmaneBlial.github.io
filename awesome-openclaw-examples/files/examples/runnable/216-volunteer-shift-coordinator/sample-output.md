# Illustrative Sample Output - Volunteer Shift Coordinator
...
- Signal: shift requests, availability, and confirmed assignments produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a coverage view with conflicts and a draft contact queue.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- shifts covered without double-booking: baseline pending from the first two runs.
