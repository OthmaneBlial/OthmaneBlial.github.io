# Illustrative Sample Output - Lesson Objective Alignment Check
...
- Signal: lesson objectives, activities, and assessment prompts produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for an alignment review showing where practice or assessment is missing.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- lessons with an assessed objective: baseline pending from the first two runs.
