# Illustrative Sample Output - Creative Review Queue
...
- Signal: creative requests, due dates, reviewers, and current versions produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a prioritized review queue that keeps version and owner visible.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- assets reviewed before their due date: baseline pending from the first two runs.
