# Illustrative Sample Output - Brand Voice Consistency Review
...
- Signal: approved voice examples and a draft asset produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a review rubric with concrete edits and examples, not a generic score.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- drafts returned with actionable voice feedback: baseline pending from the first two runs.
