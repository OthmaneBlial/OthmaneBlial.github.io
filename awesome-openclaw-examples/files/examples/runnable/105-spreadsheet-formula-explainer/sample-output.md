# Illustrative Sample Output - Spreadsheet Formula Explainer
...
- Signal: selected spreadsheet formulas and nearby labels produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a plain-language explanation plus edge cases to review.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- formula review time per sheet: baseline pending from the first two runs.
