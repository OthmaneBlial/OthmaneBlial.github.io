# Illustrative Sample Output - QBR Storyboard Builder
...
- Signal: approved outcomes, usage signals, support history, and goals produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a QBR storyboard that links each claim to evidence.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- QBR preparation time: baseline pending from the first two runs.
