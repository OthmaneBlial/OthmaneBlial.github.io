# Illustrative Sample Output - Recognition Roundup
...
- Signal: peer recognition notes and approved attribution preferences produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a draft roundup that preserves the contributor's wording and consent state.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- recognized contributions reviewed before publication: baseline pending from the first two runs.
