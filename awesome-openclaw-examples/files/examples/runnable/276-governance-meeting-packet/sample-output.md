# Illustrative Sample Output - Governance Meeting Packet
...
- Signal: agenda, risk register, evidence links, and prior decisions produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a review packet with unresolved questions and decision owners.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- governance meetings with complete pre-reads: baseline pending from the first two runs.
