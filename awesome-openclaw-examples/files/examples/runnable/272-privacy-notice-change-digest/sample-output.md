# Illustrative Sample Output - Privacy Notice Change Digest
...
- Signal: approved privacy notice versions and change notes produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a change digest with affected claims and review owners.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- notice changes reviewed before publication: baseline pending from the first two runs.
