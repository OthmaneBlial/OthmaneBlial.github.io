# Illustrative Sample Output - Case Study Evidence Pack
...
- Signal: customer results, dated source notes, and approved quotes produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a fact-checked case-study evidence pack with claim provenance.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- draft claims with a source and approver: baseline pending from the first two runs.
