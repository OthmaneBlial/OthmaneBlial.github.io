# Illustrative Sample Output - Procurement Policy Q&A Router
...
- Signal: procurement questions and approved policy material produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for an answer draft with policy citations and escalation for exceptions.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- questions resolved from approved source material: baseline pending from the first two runs.
