# Illustrative Sample Output - Town Hall Question Digest
...
- Signal: submitted questions and previous approved answers produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a deduplicated question digest with sensitive items separated.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- questions routed before the event: baseline pending from the first two runs.
