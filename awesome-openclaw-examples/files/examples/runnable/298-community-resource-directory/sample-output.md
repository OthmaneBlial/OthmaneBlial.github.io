# Illustrative Sample Output - Community Resource Directory
...
- Signal: public resource links, audience criteria, and freshness rules produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a directory draft with source dates, eligibility notes, and gaps.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- resources reviewed before being shared: baseline pending from the first two runs.
