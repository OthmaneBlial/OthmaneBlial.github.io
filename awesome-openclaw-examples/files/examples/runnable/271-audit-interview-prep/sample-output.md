# Illustrative Sample Output - Audit Interview Prep
...
- Signal: audit scope, control evidence, and likely interview topics produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a prep brief with source links and questions the owner must confirm.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- interviews with complete evidence packets: baseline pending from the first two runs.
