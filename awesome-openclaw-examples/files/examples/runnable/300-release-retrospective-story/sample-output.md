# Illustrative Sample Output - Release Retrospective Story
...
- Signal: release timeline, incidents, customer feedback, and team notes produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a retrospective narrative with evidence, lessons, and follow-up actions.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- retrospectives completed with measurable actions: baseline pending from the first two runs.
