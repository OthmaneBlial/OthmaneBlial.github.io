# Illustrative Sample Output - SaaS License Reclamation Queue
...
- Signal: license assignments, usage windows, and reclaim policy produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a reclaim-review queue with evidence and owner approval.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- unused licenses reviewed before the next billing cycle: baseline pending from the first two runs.
