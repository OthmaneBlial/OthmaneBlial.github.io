# Illustrative Sample Output - Personal Weekly Review
...
- Signal: calendar commitments, tasks, notes, and stated priorities produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a private weekly review with wins, friction, and the next three priorities.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- weekly review completed with fewer overdue commitments: baseline pending from the first two runs.
