# Illustrative Sample Output - Data Quality Incident Brief
...
- Signal: fresh data-quality alerts and owner notes produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a concise incident brief with blast radius, owner, and next check.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- time from alert to acknowledged owner: baseline pending from the first two runs.
