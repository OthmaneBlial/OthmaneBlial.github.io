# Illustrative Sample Output - Social Content Reuse Planner
...
- Signal: an approved long-form source and channel constraints produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a reuse plan with draft angles, source boundaries, and review states.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- reuse assets linked to an approved source: baseline pending from the first two runs.
