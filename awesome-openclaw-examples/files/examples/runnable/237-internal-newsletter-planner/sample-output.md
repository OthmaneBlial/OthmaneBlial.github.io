# Illustrative Sample Output - Internal Newsletter Planner
...
- Signal: approved internal stories, dates, and audience needs produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a balanced newsletter plan with source links and review state.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- issues approved on the planned editorial date: baseline pending from the first two runs.
