# Illustrative Sample Output - Stakeholder Update Composer
...
- Signal: approved progress notes, risks, and decisions produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a draft stakeholder update with claim provenance and audience variants.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- updates approved without factual corrections: baseline pending from the first two runs.
