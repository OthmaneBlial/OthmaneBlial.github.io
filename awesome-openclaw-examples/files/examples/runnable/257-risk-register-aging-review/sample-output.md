# Illustrative Sample Output - Risk Register Aging Review
...
- Signal: risk entries, owners, due dates, and mitigation updates produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for an aging review that flags stale treatment plans.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- risks with a current owner and review date: baseline pending from the first two runs.
