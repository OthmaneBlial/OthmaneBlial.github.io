# Illustrative Sample Output - Partner Meeting Brief
...
- Signal: partner history, current goals, and open commercial questions produced 7 reviewable items in the selected scope.
...
- Review the evidence queue and confirm the owner for a pre-meeting brief with evidence and questions to resolve.
- Keep the proposed output in draft state until the human reviewer approves the wording and scope.

## KPI snapshot

- meeting preparation time: baseline pending from the first two runs.
