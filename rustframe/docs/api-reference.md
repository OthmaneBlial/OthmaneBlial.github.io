...
The frontend package is currently documented at release candidate `0.1.0-rc.2`. The initial npm publication remains a public registry gate; this reference describes the source and tested package contract.
