...
`cargo test --release --locked -- --test-threads=1` passes **969 tests per binary, 967
passed, zero failures and two inherited ignored tests** on the current source, including incomplete and credential-shaped evidence and confidence-rationale rejection coverage;
