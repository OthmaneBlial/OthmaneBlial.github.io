...
`cargo test --release --locked -- --test-threads=1` passes **966 tests per binary, 966
passed, zero failures and two inherited ignored tests** on the current source, including incomplete and credential-shaped evidence rejection coverage;
